...
**(a) Función valor, función de política y trayectoria (parámetros base)** 
Grafique la función valor y la función de política para distintos valores del espacio de estados y grafíque una realización aleatoria (con semilla ja) del nivel de capital de la empresa.
...
**(b) Modificación de un parámetro: Concavidad de la función de producción (Equipo 2)** 
Modifique un parámetro del problema (equipo 2: concavidad de la función de producción), incluya las líneas de código modi cadas, y nuevamente grafíque la función valor, la función de política y la trayectoria para la misma realización aleatoria de la productividad y compárelas con lo obtenido en el inciso anterior.
